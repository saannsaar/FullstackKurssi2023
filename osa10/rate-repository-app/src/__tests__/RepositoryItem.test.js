import RepositoryList, { RepositoryContainer } from '../components/RepositoryList';
...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        render(<RepositoryContainer repositories={repositories} loading={false}/>);
  
        const repositoryItems = screen.getAllByTestId('RepositoryItem');
        console.log(screen.getAllByTestId('RepositoryItem'))
        const [firstRepositoryItem, secondRepositoryItem] = repositoryItems;

        console.log(firstRepositoryItem.children)
